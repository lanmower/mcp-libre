...
MCP_TEMPLATE="$PROJECT_ROOT/config/mcp.config.json.template"
CLAUDE_TEMPLATE="$PROJECT_ROOT/config/claude_config.json.template"
...
generate_claude_config() {
    ...
    sed "s|/path/to/mcp-libre|$PROJECT_ROOT|g" "$CLAUDE_TEMPLATE" > "$claude_file"
...
generate_mcp_config() {
    ...
    sed "s|/path/to/mcp-libre|$PROJECT_ROOT|g" "$MCP_TEMPLATE" > "$output_file"
